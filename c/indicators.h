...
/* Options: period */
/* Outputs: beta */
#define TI_INDICATOR_BETA_INDEX 16
...
/* Options: none */
/* Outputs: bop */
#define TI_INDICATOR_BOP_INDEX 17
...
/* Options: period */
/* Outputs: cci */
#define TI_INDICATOR_CCI_INDEX 18
...
/* Options: none */
/* Outputs: ceil */
#define TI_INDICATOR_CEIL_INDEX 19
...
/* Options: period */
/* Outputs: cmo */
#define TI_INDICATOR_CMO_INDEX 20
...
/* Options: period */
/* Outputs: correl */
#define TI_INDICATOR_CORREL_INDEX 21
...
/* Options: none */
/* Outputs: cos */
#define TI_INDICATOR_COS_INDEX 22
...
/* Options: none */
/* Outputs: cosh */
#define TI_INDICATOR_COSH_INDEX 23
...
/* Options: none */
/* Outputs: crossany */
#define TI_INDICATOR_CROSSANY_INDEX 24
...
/* Options: none */
/* Outputs: crossover */
#define TI_INDICATOR_CROSSOVER_INDEX 25
...
/* Options: period */
/* Outputs: cvi */
#define TI_INDICATOR_CVI_INDEX 26
...
/* Options: period */
/* Outputs: decay */
#define TI_INDICATOR_DECAY_INDEX 27
...
/* Options: period */
/* Outputs: dema */
#define TI_INDICATOR_DEMA_INDEX 28
...
#define TI_INDICATOR_DI_INDEX 29
...
/* Options: none */
/* Outputs: div */
#define TI_INDICATOR_DIV_INDEX 30
...
#define TI_INDICATOR_DM_INDEX 31
...
/* Options: period */
/* Outputs: dpo */
#define TI_INDICATOR_DPO_INDEX 32
...
/* Options: period */
/* Outputs: dx */
#define TI_INDICATOR_DX_INDEX 33
...
/* Options: period */
/* Outputs: edecay */
#define TI_INDICATOR_EDECAY_INDEX 34
...
/* Options: period */
/* Outputs: ema */
#define TI_INDICATOR_EMA_INDEX 35
...
/* Options: none */
/* Outputs: emv */
#define TI_INDICATOR_EMV_INDEX 36
...
/* Options: none */
/* Outputs: exp */
#define TI_INDICATOR_EXP_INDEX 37
...
#define TI_INDICATOR_FISHER_INDEX 38
...
/* Options: none */
/* Outputs: floor */
#define TI_INDICATOR_FLOOR_INDEX 39
...
/* Options: period */
/* Outputs: fosc */
#define TI_INDICATOR_FOSC_INDEX 40
...
/* Options: period */
/* Outputs: hma */
#define TI_INDICATOR_HMA_INDEX 41
...
/* Options: none */
/* Outputs: ht_dcperiod */
#define TI_INDICATOR_HT_DCPERIOD_INDEX 42
...
/* Options: none */
/* Outputs: ht_dcphase */
#define TI_INDICATOR_HT_DCPHASE_INDEX 43
...
/* Type: indicator */
/* Input arrays: 1    Options: 0    Output arrays: 2 */
/* Inputs: real */
/* Options: none */
/* Outputs: inphase, quadrature */
#define TI_INDICATOR_HT_PHASOR_INDEX 44
...
#define TI_INDICATOR_HT_SINE_INDEX 45
...
#define TI_INDICATOR_HT_TRENDLINE_INDEX 46
...
#define TI_INDICATOR_HT_TRENDMODE_INDEX 47
...
/* Options: period */
/* Outputs: imi */
#define TI_INDICATOR_IMI_INDEX 48
...
/* Options: period */
/* Outputs: kama */
#define TI_INDICATOR_KAMA_INDEX 49
...
/* Options: short_period, long_period */
/* Outputs: kvo */
#define TI_INDICATOR_KVO_INDEX 50
...
/* Options: period */
/* Outputs: lag */
#define TI_INDICATOR_LAG_INDEX 51
...
#define TI_INDICATOR_LINEARREGANGLE_INDEX 52
...
/* Options: period */
/* Outputs: linreg */
#define TI_INDICATOR_LINREG_INDEX 53
...
#define TI_INDICATOR_LINREGINTERCEPT_INDEX 54
...
/* Options: period */
/* Outputs: linregslope */
#define TI_INDICATOR_LINREGSLOPE_INDEX 55
...
/* Options: none */
/* Outputs: ln */
#define TI_INDICATOR_LN_INDEX 56
...
/* Options: none */
/* Outputs: log10 */
#define TI_INDICATOR_LOG10_INDEX 57
...
/* Input arrays: 1    Options: 2    Output arrays: 1 */
/* Inputs: real */
/* Options: period, ma_type */
/* Outputs: ma */
#define TI_INDICATOR_MA_INDEX 58
...
#define TI_INDICATOR_MACD_INDEX 59
...
/* Type: indicator */
/* Input arrays: 1    Options: 6    Output arrays: 3 */
/* Inputs: real */
/* Options: fast_period, fast_ma_type, slow_period, slow_ma_type, signal_period, signal_ma_type */
/* Outputs: macd, macd_signal, macd_histogram */
#define TI_INDICATOR_MACDEXT_INDEX 60
...
/* Type: indicator */
/* Input arrays: 1    Options: 1    Output arrays: 3 */
/* Inputs: real */
/* Options: signal_period */
/* Outputs: macd, macd_signal, macd_histogram */
#define TI_INDICATOR_MACDFIX_INDEX 61
...
/* Inputs: real */
/* Options: fast limit, slow limit */
/* Outputs: mama, fama */
#define TI_INDICATOR_MAMA_INDEX 62
...
/* Type: overlay */
/* Input arrays: 2    Options: 3    Output arrays: 1 */
/* Inputs: real, periods */
/* Options: min_period, max_period, ma_type */
/* Outputs: mavp */
#define TI_INDICATOR_MAVP_INDEX 65
...
/* Options: period */
/* Outputs: max */
#define TI_INDICATOR_MAX_INDEX 66
...
/* Maximum Index In Period */
/* Type: math */
/* Input arrays: 1    Options: 1    Output arrays: 1 */
/* Inputs: real */
/* Options: period */
/* Outputs: maxindex */
#define TI_INDICATOR_MAXINDEX_INDEX 67
int ti_maxindex_start(TI_REAL const *options);
int ti_maxindex(int size, TI_REAL const *const *inputs, TI_REAL const *options, TI_REAL *const *outputs);
...
/* Options: period */
/* Outputs: md */
#define TI_INDICATOR_MD_INDEX 68
...
/* Options: none */
/* Outputs: medprice */
#define TI_INDICATOR_MEDPRICE_INDEX 69
...
/* Options: period */
/* Outputs: mfi */
#define TI_INDICATOR_MFI_INDEX 70
...
/* Options: period */
/* Outputs: midpoint */
#define TI_INDICATOR_MIDPOINT_INDEX 71
...
/* Options: period */
/* Outputs: midprice */
#define TI_INDICATOR_MIDPRICE_INDEX 72
...
/* Options: period */
/* Outputs: min */
#define TI_INDICATOR_MIN_INDEX 73
...
/* Minimum Index In Period */
/* Type: math */
/* Input arrays: 1    Options: 1    Output arrays: 1 */
/* Inputs: real */
/* Options: period */
/* Outputs: minindex */
#define TI_INDICATOR_MININDEX_INDEX 74
int ti_minindex_start(TI_REAL const *options);
int ti_minindex(int size, TI_REAL const *const *inputs, TI_REAL const *options, TI_REAL *const *outputs);
/* Minimum And Maximum In Period */
/* Type: math */
/* Input arrays: 1    Options: 1    Output arrays: 2 */
/* Inputs: real */
/* Options: period */
/* Outputs: min, max */
#define TI_INDICATOR_MINMAX_INDEX 75
int ti_minmax_start(TI_REAL const *options);
int ti_minmax(int size, TI_REAL const *const *inputs, TI_REAL const *options, TI_REAL *const *outputs);
/* Minimum And Maximum Index In Period */
/* Type: math */
/* Input arrays: 1    Options: 1    Output arrays: 2 */
/* Inputs: real */
/* Options: period */
/* Outputs: minindex, maxindex */
#define TI_INDICATOR_MINMAXINDEX_INDEX 76
int ti_minmaxindex_start(TI_REAL const *options);
int ti_minmaxindex(int size, TI_REAL const *const *inputs, TI_REAL const *options, TI_REAL *const *outputs);
/* Momentum */
/* Type: indicator */
/* Input arrays: 1    Options: 1    Output arrays: 1 */
/* Inputs: real */
/* Options: period */
/* Outputs: mom */
#define TI_INDICATOR_MOM_INDEX 77
...
#define TI_INDICATOR_MSW_INDEX 78
...
/* Options: none */
/* Outputs: mul */
#define TI_INDICATOR_MUL_INDEX 79
...
/* Options: period */
/* Outputs: natr */
#define TI_INDICATOR_NATR_INDEX 80
...
/* Options: none */
/* Outputs: nvi */
#define TI_INDICATOR_NVI_INDEX 81
...
/* Options: none */
/* Outputs: obv */
#define TI_INDICATOR_OBV_INDEX 82
...
/* Options: short_period, long_period */
/* Outputs: ppo */
#define TI_INDICATOR_PPO_INDEX 83
...
/* Outputs: psar */
#define TI_INDICATOR_PSAR_INDEX 84
...
/* Options: none */
/* Outputs: pvi */
#define TI_INDICATOR_PVI_INDEX 85
...
/* Options: period */
/* Outputs: qstick */
#define TI_INDICATOR_QSTICK_INDEX 86
...
/* Options: period */
/* Outputs: roc */
#define TI_INDICATOR_ROC_INDEX 87
...
/* Options: period */
/* Outputs: rocr */
#define TI_INDICATOR_ROCR_INDEX 88
...
/* Options: period */
/* Outputs: rocr100 */
#define TI_INDICATOR_ROCR100_INDEX 89
...
/* Options: none */
/* Outputs: round */
#define TI_INDICATOR_ROUND_INDEX 90
...
/* Options: period */
/* Outputs: rsi */
#define TI_INDICATOR_RSI_INDEX 91
...
/* Type: overlay */
/* Input arrays: 2    Options: 8    Output arrays: 1 */
/* Inputs: high, low */
/* Options: start_value, offset_on_reverse, acceleration_init_long, acceleration_long, acceleration_max_long, acceleration_init_short, acceleration_short, acceleration_max_short */
/* Outputs: sarext */
#define TI_INDICATOR_SAREXT_INDEX 92
...
/* Options: none */
/* Outputs: sin */
#define TI_INDICATOR_SIN_INDEX 93
...
/* Options: none */
/* Outputs: sinh */
#define TI_INDICATOR_SINH_INDEX 94
...
/* Options: period */
/* Outputs: sma */
#define TI_INDICATOR_SMA_INDEX 95
...
/* Options: none */
/* Outputs: sqrt */
#define TI_INDICATOR_SQRT_INDEX 96
...
/* Options: period */
/* Outputs: stddev */
#define TI_INDICATOR_STDDEV_INDEX 97
...
/* Options: period */
/* Outputs: stderr */
#define TI_INDICATOR_STDERR_INDEX 98
...
#define TI_INDICATOR_STOCH_INDEX 99
...
/* Options: period */
/* Outputs: stochrsi */
#define TI_INDICATOR_STOCHRSI_INDEX 100
...
/* Options: none */
/* Outputs: sub */
#define TI_INDICATOR_SUB_INDEX 101
...
/* Options: period */
/* Outputs: sum */
#define TI_INDICATOR_SUM_INDEX 102
...
/* Input arrays: 1    Options: 2    Output arrays: 1 */
/* Inputs: real */
/* Options: period, vfactor */
/* Outputs: t3 */
#define TI_INDICATOR_T3_INDEX 103
...
/* Options: none */
/* Outputs: tan */
#define TI_INDICATOR_TAN_INDEX 104
...
/* Options: none */
/* Outputs: tanh */
#define TI_INDICATOR_TANH_INDEX 105
...
/* Options: period */
/* Outputs: tema */
#define TI_INDICATOR_TEMA_INDEX 106
...
/* Options: none */
/* Outputs: degrees */
#define TI_INDICATOR_TODEG_INDEX 107
...
/* Options: none */
/* Outputs: radians */
#define TI_INDICATOR_TORAD_INDEX 108
...
/* Options: none */
/* Outputs: tr */
#define TI_INDICATOR_TR_INDEX 109
...
/* Options: period */
/* Outputs: trima */
#define TI_INDICATOR_TRIMA_INDEX 110
...
/* Options: period */
/* Outputs: trix */
#define TI_INDICATOR_TRIX_INDEX 111
...
/* Options: none */
/* Outputs: trunc */
#define TI_INDICATOR_TRUNC_INDEX 112
...
/* Options: period */
/* Outputs: tsf */
#define TI_INDICATOR_TSF_INDEX 113
...
/* Options: none */
/* Outputs: typprice */
#define TI_INDICATOR_TYPPRICE_INDEX 114
...
/* Outputs: ultosc */
#define TI_INDICATOR_ULTOSC_INDEX 115
...
/* Options: period */
/* Outputs: var */
#define TI_INDICATOR_VAR_INDEX 116
...
/* Options: period */
/* Outputs: vhf */
#define TI_INDICATOR_VHF_INDEX 117
...
/* Outputs: vidya */
#define TI_INDICATOR_VIDYA_INDEX 118
...
/* Options: period */
/* Outputs: volatility */
#define TI_INDICATOR_VOLATILITY_INDEX 119
...
/* Options: short_period, long_period */
/* Outputs: vosc */
#define TI_INDICATOR_VOSC_INDEX 120
...
/* Options: period */
/* Outputs: vwma */
#define TI_INDICATOR_VWMA_INDEX 121
...
/* Options: none */
/* Outputs: wad */
#define TI_INDICATOR_WAD_INDEX 122
...
/* Options: none */
/* Outputs: wcprice */
#define TI_INDICATOR_WCPRICE_INDEX 123
...
/* Options: period */
/* Outputs: wilders */
#define TI_INDICATOR_WILDERS_INDEX 124
...
/* Options: period */
/* Outputs: willr */
#define TI_INDICATOR_WILLR_INDEX 125
...
/* Options: period */
/* Outputs: wma */
#define TI_INDICATOR_WMA_INDEX 126
...
/* Options: period */
/* Outputs: zlema */
#define TI_INDICATOR_ZLEMA_INDEX 127
